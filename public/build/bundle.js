...
var app = (function () {
    ...
    // (115:4) <Button type="secondary" on:click={toggleLogIn}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(115:4) <Button type=\\\"secondary\\\" on:click={toggleLogIn}>",
    		ctx
    	});
    ...
    // (116:4) <Button type="secondary" on:click={toggleCreateNUser}>
    function create_default_slot(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("Registrera dig");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(116:4) <Button type=\\\"secondary\\\" on:click={toggleCreateNUser}>",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h3, "class", "svelte-157saqg");
    			add_location(h3, file, 128, 4, 3395);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    		},
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h3, "class", "svelte-157saqg");
    			add_location(h3, file, 126, 4, 3333);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h3, "class", "color svelte-157saqg");
    			add_location(h3, file, 124, 4, 3262);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    		},
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h3, "class", "svelte-157saqg");
    			add_location(h3, file, 122, 4, 3169);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h3, "class", "svelte-157saqg");
    			add_location(h3, file, 120, 4, 3075);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(120:2) {#if ErrorNotFoundUser}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-157saqg");
    			add_location(div, file, 113, 2, 2859);
    			attr_dev(main, "class", "svelte-157saqg");
    			add_location(main, file, 112, 0, 2825);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
